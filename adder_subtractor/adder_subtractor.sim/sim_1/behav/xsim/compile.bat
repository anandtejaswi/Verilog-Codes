...
REM
REM Generated by Vivado on Wed Nov 19 20:25:03 +0530 2025
...
echo "xvlog --incr --relax -prj tb_adder_subtractor_vlog.prj"
call xvlog  --incr --relax -prj tb_adder_subtractor_vlog.prj -log xvlog.log
