...
REM
REM Generated by Vivado on Wed Nov 19 20:30:31 +0530 2025
...
echo "xvlog --incr --relax -prj tb_universal_add_sub_vlog.prj"
call xvlog  --incr --relax -prj tb_universal_add_sub_vlog.prj -log xvlog.log
