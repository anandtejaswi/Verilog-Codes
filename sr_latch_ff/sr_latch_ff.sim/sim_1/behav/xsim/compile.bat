...
REM
REM Generated by Vivado on Wed Nov 19 20:37:00 +0530 2025
...
echo "xvlog --incr --relax -prj tb_sr_latch_and_flipflop_vlog.prj"
call xvlog  --incr --relax -prj tb_sr_latch_and_flipflop_vlog.prj -log xvlog.log
