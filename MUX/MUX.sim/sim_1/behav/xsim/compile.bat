...
REM
REM Generated by Vivado on Wed Nov 19 20:05:01 +0530 2025
...
echo "xvlog --incr --relax -prj tb_muxes_vlog.prj"
call xvlog  --incr --relax -prj tb_muxes_vlog.prj -log xvlog.log
