...
REM
REM Generated by Vivado on Wed Nov 19 21:31:00 +0530 2025
...
echo "xvlog --incr --relax -prj tb_counters_vlog.prj"
call xvlog  --incr --relax -prj tb_counters_vlog.prj -log xvlog.log
