...
REM
REM Generated by Vivado on Wed Nov 19 20:42:10 +0530 2025
...
echo "xvlog --incr --relax -prj tb_d_jk_flipflops_vlog.prj"
call xvlog  --incr --relax -prj tb_d_jk_flipflops_vlog.prj -log xvlog.log
