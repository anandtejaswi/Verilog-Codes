...
REM
REM Generated by Vivado on Wed Nov 19 20:17:07 +0530 2025
...
echo "xvlog --incr --relax -prj tb_priority_encod_decod_vlog.prj"
call xvlog  --incr --relax -prj tb_priority_encod_decod_vlog.prj -log xvlog.log
